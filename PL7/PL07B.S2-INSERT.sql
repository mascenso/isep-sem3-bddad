...
-- tabela CD 
INSERT INTO cd(codCd, idEditora, titulo, dataCompra, valorPago, localCompra) VALUES (1, 8, 'Punkzilla', TO_DATE('22/April/2011','DD/MON/YY'), 55.00 , 'FNAC');
INSERT INTO cd(codCd, idEditora, titulo, dataCompra, valorPago, localCompra) VALUES (2, 1, 'Classic Duets', TO_DATE('21/May/2017','DD/MON/YY'), 30.50, 'Worten');
INSERT INTO cd(codCd, idEditora, titulo, dataCompra, valorPago, localCompra) VALUES (3, 7, 'The Wall', TO_DATE('22/April/2011','DD/MON/YY'), 25.80, 'FNAC');
INSERT INTO cd(codCd, idEditora, titulo, dataCompra, valorPago, localCompra) VALUES (4, 1, 'Hits 4', TO_DATE('10/September/2017','DD/MON/YY'), 42.30, 'Worten');
INSERT INTO cd(codCd, idEditora, titulo, dataCompra, valorPago, localCompra) VALUES (5, 6, 'Songs of Experience', TO_DATE('1/January/2018','DD/MON/YY'), 10.99, NULL);
INSERT INTO cd(codCd, idEditora, titulo, dataCompra, valorPago, localCompra) VALUES (6, 5, 'Giesta 2', TO_DATE('15/June/2017','DD/MON/YY'), 9.10, NULL);
INSERT INTO cd(codCd, idEditora, titulo, dataCompra, valorPago, localCompra) VALUES (7, 4, 'O Mundo ao Contrario', TO_DATE('01/January/2004','DD/MON/YY'), 12.90, 'FNAC');
INSERT INTO cd(codCd, idEditora, titulo, dataCompra, valorPago, localCompra) VALUES (8, 3, 'Born to Die', TO_DATE('27/January/2012','DD/MON/YY'), 9.90, 'iTunes');
...
--CD 2
INSERT INTO musica(nrMusica, codCd, titulo, interprete, duracao) VALUES (1, 2, 'Bizet: Les pecheurs de perles...', 'Orquestra Filarmonica Real', 5.24);
INSERT INTO musica(nrMusica, codCd, titulo, interprete, duracao) VALUES (2, 2, 'Verdi: Otello/Act 2', 'Orquestra Sinfonica Chicago', 6.47);
...
--CD 6
INSERT INTO musica(nrMusica, codCd, titulo, interprete, duracao) VALUES (1, 6, 'Valsa em Espiral', 'Miguel Araujo', 3.34);
INSERT INTO musica(nrMusica, codCd, titulo, interprete, duracao) VALUES (2, 6, '1987' , 'Miguel Araujo', 4.12);
INSERT INTO musica(nrMusica, codCd, titulo, interprete, duracao) VALUES (3, 6, 'Meio Conto', 'Miguel Araujo', 3.13);
INSERT INTO musica(nrMusica, codCd, titulo, interprete, duracao) VALUES (4, 6, 'Via Norte', 'Miguel Araujo', 3.35);
INSERT INTO musica(nrMusica, codCd, titulo, interprete, duracao) VALUES (5, 6, 'Sangemil', 'Miguel Araujo', 4.03);
INSERT INTO musica(nrMusica, codCd, titulo, interprete, duracao) VALUES (6, 6, 'Lurdes Valsa Lenta', 'Miguel Araujo', 4.41);
INSERT INTO musica(nrMusica, codCd, titulo, interprete, duracao) VALUES (7, 6, 'Axl Rose', 'Miguel Araujo', 5.03);
INSERT INTO musica(nrMusica, codCd, titulo, interprete, duracao) VALUES (8, 6, '20% Mais', 'Miguel Araujo', 1.20);
INSERT INTO musica(nrMusica, codCd, titulo, interprete, duracao) VALUES (9, 6, 'Vandalo', 'Miguel Araujo', 4.45);
INSERT INTO musica(nrMusica, codCd, titulo, interprete, duracao) VALUES (10, 6, 'Aqui Dali', 'Miguel Araujo', 4.45);
--CD 7
INSERT INTO musica(nrMusica, codCd, titulo, interprete, duracao) VALUES (1, 7, 'Desejo', 'Xutos e Pontapes', 3.25);
INSERT INTO musica(nrMusica, codCd, titulo, interprete, duracao) VALUES (2, 7, 'Diz-me' , 'Xutos e Pontapes', 4.37);
INSERT INTO musica(nrMusica, codCd, titulo, interprete, duracao) VALUES (3, 7, 'Ai Se Ele Cai', 'Xutos e Pontapes', 3.12);
INSERT INTO musica(nrMusica, codCd, titulo, interprete, duracao) VALUES (4, 7, 'Pequeno Pormenor', 'Xutos e Pontapes', 2.58);
INSERT INTO musica(nrMusica, codCd, titulo, interprete, duracao) VALUES (5, 7, 'Zona Limite', 'Xutos e Pontapes', 3.27);
INSERT INTO musica(nrMusica, codCd, titulo, interprete, duracao) VALUES (6, 7, 'Fim de Semana', 'Xutos e Pontapes', 5.27);
INSERT INTO musica(nrMusica, codCd, titulo, interprete, duracao) VALUES (7, 7, 'Gota a Gota', 'Xutos e Pontapes', 2.35);
INSERT INTO musica(nrMusica, codCd, titulo, interprete, duracao) VALUES (8, 7, 'Teimosia', 'Xutos e Pontapes', 4.13);
INSERT INTO musica(nrMusica, codCd, titulo, interprete, duracao) VALUES (9, 7, 'O Mundo ao Contrario', 'Xutos e Pontapes', 4.18);
INSERT INTO musica(nrMusica, codCd, titulo, interprete, duracao) VALUES (10, 7, 'Sombra Colorida', 'Xutos e Pontapes', 2.38);
--CD 8
